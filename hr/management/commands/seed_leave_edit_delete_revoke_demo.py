...
Leave Requests (self-submitted unless noted):
  1. Pending (Sep 1-2)                         -> Edit/Delete for the employee
  ...
  6-8. Three PENDING requests logged by the manager on the employee's behalf
       (Sep 25-26, Sep 28-29, Oct 1-2) -> Edit/Delete on the manager's Reporting
       Structure card, and the "+1 more" collapse (2 visible, 1 tucked away)

Attendance Exceptions (self-submitted, manager = demo.edr.manager):
  9.  Pending (Sep 3)                          -> Edit/Delete for the employee
  10. Approved (Sep 7)                         -> Request Revoke
  11. Approved, revoke already requested (Sep 12) -> shows in the manager's queue
  12. Revoked directly by HR (Sep 17)           -> Revoked badge + reason
...
User = get_user_model()
TAG_PREFIX = 'DEMO-EDR-'
USERNAMES = ['demo.edr.employee', 'demo.edr.manager', 'demo.edr.approver', 'demo.edr.hr']
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # 1. Pending — self-submitted, still editable/deletable.
        ...
        # 6-8. Three requests the manager logged on the employee's behalf, all still pending.
        ...
        # 9. Pending attendance exception — self-submitted, still editable/deletable.
        ...
        # 10. Approved attendance exception.
        ...
        # 11. Approved, with a revoke request already pending review.
        ...
        self.stdout.write(self.style.SUCCESS(
            ...
            '  - demo.edr.employee (Fatima Al-Harbi): My Profile shows all 5 leave-request states '
            'and all 4 attendance-exception states.\n'
            ...
            '  - demo.edr.approver (Sara Al-Qahtani): decides Fatima\'s leave requests.\n'
            '  - demo.edr.hr (Super Admin, override access): Leave Requests queue shows a pending '
            'revoke request and a revocable approved request in History; can decide revoke requests '
            'on both the Leave Requests queue and Team Exceptions.'
        ))
