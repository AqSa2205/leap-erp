...
urlpatterns = [
    ...
    path('my-profile/documents/upload/', views.my_document_upload, name='my_document_upload'),
    path('my-profile/documents/export/pdf/', views.my_documents_export_pdf, name='my_documents_export_pdf'),
    path('my-profile/documents/<int:pk>/delete/', views.my_document_delete, name='my_document_delete'),
